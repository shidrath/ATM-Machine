...
public class Bank {
	...
	public String getNewUserUUID() {
		...
		do {
			...
			uuid = "";
			for (int c = 0; c < len; c++) {
				uuid += ((Integer) rngRandom.nextInt(10)).toString();
			}
		...
		} while (nonUnique);// while we don't have an unique uuid keep generating a new one
	...
	public String getNewAccountUUID() {
		...
		} while (nonUnique);// while we dont have an unique uuid keep generating a new one
